...
pub use self::{
    ...
    model::{
        validated_sidebar_bounds, AgentPanelSortConfig, BorderStyle, ChromeColorsConfig, Config,
        ...
        ToastDelivery, ToastHerdrPosition, UiConfig, UpdateChannelConfig, MAX_TOAST_DELAY_SECONDS,
    },
    sidebar::{
